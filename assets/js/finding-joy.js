...
const questions = [
  {
    question: "What is a hallmark symptom of depression that involves the inability to find pleasure?",
    answers: [
  ...
  {
    question: "Which neurotransmitter is known as the 'cuddle hormone' that promotes feelings of connectedness?",
    answers: [
      { text: "Dopamine", correct: false },
      { text: "Serotonin", correct: false },
      { text: "Oxytocin", correct: true },
      { text: "Endorphins", correct: false }
    ]
  },
  {
    question: "What practice is suggested to help cultivate a joyous mindset?",
    answers: [
      { text: "Avoiding physical activity", correct: false },
      { text: "Embracing novelty", correct: true },
      { text: "Focusing solely on financial gains", correct: false },
      { text: "Spending time in isolation", correct: false }
    ]
  }
