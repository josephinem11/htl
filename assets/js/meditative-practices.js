...
const questions = [
  {
    question: "Which meditation practice focuses on cultivating feelings of love and care towards oneself and others?",
    answers: [
      { text: "Breathing Meditation", correct: false },
      { text: "Body Scan", correct: false },
      { text: "Loving-Kindness Meditation", correct: true },
      { text: "Observing-Thought Meditation", correct: false }
    ]
  },
  {
    question: "What is the primary focus of Body Scan meditation?",
    answers: [
      { text: "Enhancing positive emotions", correct: false },
      { text: "Paying attention to each part of the body sequentially", correct: true },
      { text: "Cultivating warmth towards others", correct: false },
      { text: "Increasing awareness of thought patterns", correct: false }
    ]
  },
  {
    question: "Observing-Thought Meditation is particularly useful for:",
    answers: [
      { text: "Reducing negative thoughts about the past and future", correct: false },
      { text: "Improving physical health", correct: false },
      { text: "Fostering feelings of love and care", correct: false },
      { text: "Increasing awareness of thought patterns", correct: true }
    ]
  }
